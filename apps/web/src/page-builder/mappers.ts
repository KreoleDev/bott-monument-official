...
export function mapHero(section: HomepageSection, _extras: PageExtras) {
  return { section };
}

export function mapMarquee(section: HomepageSection, _extras: PageExtras) {
  return { section };
}

export function mapFounder(section: HomepageSection, _extras: PageExtras) {
  return { section };
}
...
export function mapShowroom(section: HomepageSection, _extras: PageExtras) {
  return { section };
}
...
export function mapContact(section: HomepageSection, _extras: PageExtras) {
  return { section };
}
