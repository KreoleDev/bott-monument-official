...
export async function seedShowroom(strapi: Core.Strapi) {
  ...
  if (!media) {
    const filepath = path.resolve(
      ...
      "../../bott-monument-design/images/office1.jpeg",
    );
    ...
    [media] = await strapi
      ...
      .service("upload")
      .upload({
        data: { fileInfo: { name, alternativeText: "Bott Monument showroom interior" } },
